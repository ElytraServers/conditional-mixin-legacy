...
public interface ConditionTester {
    ...
    /**
     * This method will be called when parsing the {@link Condition} annotation to determine if the condition is
     * satisfied
     * 
     * @param mixinClassName The class name of your mixin class. Passed from
     *                       {@link org.spongepowered.asm.mixin.extensibility.IMixinConfigPlugin#shouldApplyMixin}
